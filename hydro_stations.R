...
Wwa_all_graph <- ggof(Wwa_all$FLOW_OUTcms, Wwa_all$Q, dates = Wwa_all$date)

  png(height=1000, width=2000, file="D:/Ptaki_hydro/Obliczenia/R/Kalibracja_Q_PL/GoF/Wwa_all_graph.png", type = "cairo")
...
png(height=1000, width=2000, file="D:/Ptaki_hydro/Obliczenia/R/Kalibracja_Q_PL/GoF/Gusin_all_graph.png", type = "cairo")
  ggof(Gusin_all$FLOW_OUTcms, Gusin_all$Q, dates = Gusin_all$date)
  dev.off()
...
png(height=1000, width=2000, file="D:/Ptaki_hydro/Obliczenia/R/Kalibracja_Q_PL/GoF/Deblin_all_graph.png", type = "cairo")
  ggof(Deblin_all$FLOW_OUTcms, Deblin_all$Q, dates = Deblin_all$date)
  dev.off()
...
png(height=1000, width=2000, file="D:/Ptaki_hydro/Obliczenia/R/Kalibracja_Q_PL/GoF/Pulawy_all_graph.png", type = "cairo")
  ggof(Pulawy_all$FLOW_OUTcms, Pulawy_all$Q, dates = Pulawy_all$date)
  dev.off()
...
png(height=1000, width=2000, file="D:/Ptaki_hydro/Obliczenia/R/Kalibracja_Q_PL/GoF/Annopol_all_graph.png", type = "cairo")
  ggof(Annopol_all$FLOW_OUTcms, Annopol_all$Q, dates = Annopol_all$date)
  dev.off()
